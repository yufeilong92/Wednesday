...
import com.xuechuan.xcedu.ui.bank.CaseNewTextActivity;
...
import com.xuechuan.xcedu.ui.bank.SpecialTextActivity;
...
//    private AnswerEvaluateAdapter mEvalueAdapter;
     ...
     * 章节练习
     */
    private CaseNewTextActivity mCaseNewTextActivity;
    /**
     * 顺序练习
     */
    ...
    private TextView mTvGmEightQuestionTitle;
     ...
     * @return
     */
    public static GmReadTwoFragment newInstance(QuestionSqliteVo vo, int postion, String mCouserid) {
...
//        mEvalueAdapter = new AnswerEvaluateAdapter(mContext, mArray);
    ...
    private void initView(View view) {
        ...
        //简答题布局
        mTvGmEightQuestionTitle = (TextView) view.findViewById(R.id.tv_gm_eight_question_title);
        mTvGmEightQuestionTitle.setOnClickListener(this);
        ...
        mLlGmEightLookJiexi.setOnClickListener(this);
    ...
    private void initShowView() {
        ...
        //简答布局与选项布局有冲突
        if (mQuestionSqliteVo.getQuestiontype() == 4) {//简答模式
            //选项布局
            ...
            //简答布局
            mLlGmeightJiandaLayout.setVisibility(View.VISIBLE);

        } else if (mQuestionSqliteVo.getQuestiontype() == 5) {//阅读理解模式
            //选项布局
            mLlGmOneSelectLayout.setVisibility(View.GONE);
            //阅读理解头
            mLlGmtitleSelectLayout.setVisibility(View.GONE);
    ...
    public void refresh() {
        ...
        setImgBg();
        setFontSize();
        if (mCaseNewTextActivity != null) {
            mCaseNewTextActivity.changerColor(mGmReadColorManger);
        }
    ...
    private void initDoEvent() {
        ...
        CaseNewTextActivity mActivity;
        if (getActivity() instanceof CaseNewTextActivity) {
            mActivity = (CaseNewTextActivity) getActivity();
            vo = mActivity.queryUserData(mQuestionSqliteVo.getQuestion_id());
        }
        if (vo == null) return;
    ...
    private void setFontSize() {
        ...
        mTvGmEightQuestionTitle.setTextSize(mGmFontSizeUtil.getFontSize());
...
//        mLiBResolveBuy.setBackgroundColor(mGmReadColorManger.getmLayoutBgColor());
        ...
        mTvGmEightQuestionTitle.setTextColor(mGmReadColorManger.getmTextTitleColor());
    ...
    private void readDataBindView() {
        ...
        //简答题
        mTvGmEightQuestionTitle.setText(getString(question));
        mTvGmEightAnswerTitleContent.setText(mQuestionSqliteVo.getExplainedStr());
        mTvGmsevenTextContent.setText(mQuestionSqliteVo.getQuestionStr());
        bindKaoDian();
    ...
    private void registerOberovce() {
        ...
        //初始化选项图片
        if (getActivity() instanceof CaseNewTextActivity) {//章节练习
            mCaseNewTextActivity = (CaseNewTextActivity) getActivity();
        }
    ...
    private void doLookJieXiView() {
        ...
        mLlGmEightLookJiexi.setVisibility(View.VISIBLE);
        //笔记
        mLlGmthreeNoteLayout.setVisibility(View.GONE);
        //解析
        mLlGmTwoAnalysisLayout.setVisibility(View.GONE);
    ...
    private void doSaveEvent(DoBankSqliteVo vo) {
        if (mCaseNewTextActivity != null) {
            mCaseNewTextActivity.saveUserDoLog(vo);
        }
        if (mOrderTestActivity != null) {
